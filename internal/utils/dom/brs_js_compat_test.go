...
func TestBrsToPs_JavaScriptCompatibility(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "removes double BR tags before block content",
			input:    `<div class="article adbox"><br /><br /><p>Ooo good one</p></div>`,
			expected: `<div class="article adbox"><p>Ooo good one</p></div>`,
		},
		{
			name:     "removes several BR tags before block content",
